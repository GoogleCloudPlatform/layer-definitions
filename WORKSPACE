...
http_archive(
    ...
    strip_prefix = "rules_docker-5f2a1e2d2339a12c557dfd1d0129f3ade5bce616",
    urls = ["https://github.com/bazelbuild/rules_docker/archive/5f2a1e2d2339a12c557dfd1d0129f3ade5bce616.tar.gz"],
)
