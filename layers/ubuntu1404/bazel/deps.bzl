...
def deps():
    ...
    if "ubuntu1404_bazel_installer" not in excludes:
        http_file(
            name = "ubuntu1404_bazel_installer",
    ...
    if "ubuntu1404_bazel_debs" not in excludes:
        http_file(
            ...
            urls = [
                "https://storage.googleapis.com/layer-deps/ubuntu1404/bazel/debs/" + DEBS_TARBALL.revision + "_bazel_debs.tar",
            ],
        )
